...
data = pd.read_csv('connect-4.data',delimiter=',', header=None)
#x=player x has taken, o=player o has taken, b=blank
#43. Class: {win,loss,draw}
#https://archive.ics.uci.edu/ml/datasets/Connect-4
data.replace({'b': 0}, regex=False, inplace=True)
data.replace({'o': 1}, regex=False, inplace=True)
data.replace({'x': 2}, regex=False, inplace=True)
data.replace({'win': 0}, regex=False, inplace=True)
data.replace({'loss': 1}, regex=False, inplace=True)
data.replace({'draw': 2}, regex=False, inplace=True)
